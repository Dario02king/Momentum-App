...
/**
 * In Momentum this type is imported from src/core/model — it is declared here
 * so the handoff package type-checks on its own. When you drop this file into
 * the app, delete the local declaration and restore:
 *
