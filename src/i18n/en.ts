...
export const en: Translations = {
  ...
  /* ── Training plans (WP2-1) ──────────────────────────────────────────── */
  'plans.title': 'Training plans',
  'plans.empty': 'No training plan yet.',
  'plans.hint':
    'A training plan is a list of exercises you regularly train together. For example: Push, Pull, Legs, Full Body or Upper Body. You can save up to 5 plans and name them as you like.',
  'plans.new': 'New plan',
  'plans.count': '{count} exercises',
  'plans.countOne': '1 exercise',
  'plans.limit': 'At most {max} plans. Delete a plan to make room for a new one.',
  'plans.slots': '{used} of {max} plans',
  ...
  'plans.editor.moveUp': 'Move {exercise} up',
  'plans.editor.moveDown': 'Move {exercise} down',
  'plans.editor.remove': 'Remove {exercise}',
  'plans.editor.save': 'Save plan',
  'plans.editor.cancel': 'Cancel',
  'plans.editor.duplicate': 'Duplicate plan',
  'plans.editor.duplicateName': '{name} (copy)',
  'plans.editor.delete': 'Delete plan',
  'plans.editor.deleteConfirm': 'Really delete?',
  'plans.editor.deleteNote': 'Sessions already logged stay unchanged.',
  'plans.chooser.title': 'Start training',
  'plans.chooser.plans': 'Your plans',
  'plans.chooser.free': 'Free session',
  'plans.chooser.freeHint': 'Pick exercises during the session.',
  'plans.chooser.manage': 'Manage plans',
  'gym.exercise.extra': 'Extra',
  'gym.lastTime': 'Last time on {date}',
  ...
  'gymHub.training.atTarget': '{done} sessions this week ·\u00A0target\u00A0met',
  'gymHub.training.atTargetOne': '1 session this week ·\u00A0target\u00A0met',
  'gymHub.training.aboveTarget': '{done} sessions this week ·\u00A0target\u00A0{target}',
  ...
  'gymHub.plans.countOne': '1 plan',
  'gymHub.plans.manage': 'Manage plans',
  'gymHub.muscles.title': 'Muscle groups',
  'gymHub.muscles.open': 'Open muscle groups',
  'gymHub.muscles.summary': '{count} of {total} counted',
  'gymHub.muscles.overall': 'Overall {change}',
  'gymHub.muscles.trained': '{count} of {total} trained',
  'gymHub.muscles.none': 'Not trained yet',
  'gymHub.muscles.noneHint': 'After your first session you will see here how your muscle groups develop.',
