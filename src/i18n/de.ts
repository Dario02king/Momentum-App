...
export const de = {
  ...
  /* ── Trainingspläne (WP2-1) ──────────────────────────────────────────── */
  'plans.title': 'Trainingspläne',
  'plans.empty': 'Noch kein Trainingsplan.',
  'plans.hint':
    'Ein Trainingsplan ist eine Liste von Übungen, die du regelmässig zusammen trainierst. Beispiel: Push, Pull, Legs, Full Body oder Upper Body. Du kannst bis zu 5 Pläne speichern und sie frei benennen.',
  'plans.new': 'Neuer Plan',
  'plans.count': '{count} Übungen',
  'plans.countOne': '1 Übung',
  'plans.limit': 'Maximal {max} Pläne. Lösche einen Plan, um Platz für einen neuen zu schaffen.',
  'plans.slots': '{used} von {max} Plänen',
  ...
  'plans.editor.moveUp': '{exercise} nach oben',
  'plans.editor.moveDown': '{exercise} nach unten',
  'plans.editor.remove': '{exercise} entfernen',
  'plans.editor.save': 'Plan sichern',
  'plans.editor.cancel': 'Abbrechen',
  'plans.editor.duplicate': 'Plan duplizieren',
  'plans.editor.duplicateName': '{name} (Kopie)',
  'plans.editor.delete': 'Plan löschen',
  'plans.editor.deleteConfirm': 'Wirklich löschen?',
  'plans.editor.deleteNote': 'Bereits erfasste Sessions bleiben unverändert.',
  'plans.chooser.title': 'Training starten',
  'plans.chooser.plans': 'Deine Pläne',
  'plans.chooser.free': 'Freie Session',
  'plans.chooser.freeHint': 'Übungen während der Session wählen.',
  'plans.chooser.manage': 'Pläne verwalten',
  'gym.exercise.extra': 'Zusätzlich',
  'gym.lastTime': 'Zuletzt am {date}',
  ...
  'gymHub.training.atTarget': '{done} Sessions diese Woche ·\u00A0Ziel\u00A0erreicht',
  'gymHub.training.atTargetOne': '1 Session diese Woche ·\u00A0Ziel\u00A0erreicht',
  'gymHub.training.aboveTarget': '{done} Sessions diese Woche ·\u00A0Ziel\u00A0{target}',
  ...
  'gymHub.muscles.summary': '{count} von {total} gewertet',
  'gymHub.muscles.overall': 'Gesamt {change}',
  'gymHub.muscles.trained': '{count} von {total} trainiert',
  'gymHub.muscles.none': 'Noch nicht trainiert',
  'gymHub.muscles.noneHint': 'Nach deiner ersten Session siehst du hier, wie sich deine Muskelgruppen entwickeln.',
